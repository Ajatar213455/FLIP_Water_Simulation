...
void initTweakBar(){
	...
	TwType TW_TYPE_SYSCASE = TwDefineEnumFromString("System mode", g_pSimulator->getSysCasesStr());
	TwAddVarRW(g_pDUC->g_pTweakBar, "Test Scene", TW_TYPE_TESTCASE, &g_iTestCase, "");
	TwAddVarRW(g_pDUC->g_pTweakBar, "System mode", TW_TYPE_SYSCASE, &g_iSysCase, "");
